<p align="center">
  <img src="./assets/icons/icon-128.png" width="96" height="96" alt="FunPay Automation Tool">
</p>
...
<p align="center">
  ...
  <img alt="Version 3.1 Stable" src="https://img.shields.io/badge/version-3.1%20Stable-D99A16">
...
4. **Заказы и отзывы** - сценарии после оплаты и закрытия заказа, просьба оставить отзыв и автоответы по оценкам.
...
- `popup/` - быстрый пульт расширения;
- `shared/` - общая логика popup, toolbar и content scripts;
