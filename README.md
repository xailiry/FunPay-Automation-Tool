...
<p align="center">
  ...
  <img alt="Version 2.5.1" src="https://img.shields.io/badge/version-2.5.1-D99A16">
...
| Авто-поднятие | Поднимает активные категории вручную или автоматически через четыре часа после последней попытки, восстанавливает расписание после запуска Chrome и отличает кулдаун от настоящей ошибки. |
| История операций | Показывает результаты последних поднятий и запусков мультипостинга в popup расширения. |
| Встроенная справка | Объясняет обычному пользователю работу панели, мультипостинга, поднятия и способы решения частых проблем. |
